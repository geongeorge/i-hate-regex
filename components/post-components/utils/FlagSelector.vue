  ...
  >
    ...
    >
      <div v-for="(flag,key) in flaglist" :key="key">
        ...
        <span class="text-gray-500 text-sm hover:underline group cursor-pointer"
        ...
        <div v-if="flag.showDescr">
          <div class="text-sm text-gray-500 border-gray-400 border p-2 rounded">{{flag.descr}}</div>
        </div>
        </TransitionExpand>
      </div>
    </div>
